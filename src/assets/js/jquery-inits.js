...
export function startInit() {
  ...
  function containerHeight() {
    var availableHeight = $(window).height() - $('.page-container').offset().top - $('.topnavbar-fixed-bottom').outerHeight();
  ...
  // Disabled links
  $('.topnavbar-nav .disabled a').on('click', function (e) {
    e.preventDefault();
    e.stopPropagation();
  });
  ...
  $('.dropdown-menu:not(.dropdown-content), .dropdown-menu:not(.dropdown-content) .dropdown-submenu').has('li.active').addClass('active').parents('.topnavbar-nav .dropdown:not(.language-switch), .topnavbar-nav .dropup:not(.language-switch)').addClass('active');
